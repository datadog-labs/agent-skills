...
| Call an external URL or API | `references/external-http.md` |
...
- For backend function implementation details, rely on the generated app project's `AGENTS.md`; this skill defines the required external HTTP boundary, local development auth choices, and troubleshooting.
